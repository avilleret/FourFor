...
void main()
{
  ...
  float red 	= texture2D(	iChannel0, 	rcoord).r; //+staticVal;
  float green = texture2D(	iChannel0, 	gcoord).g; //+staticVal;
  float blue 	=	texture2D(	iChannel0, 	bcoord).b; //+staticVal;
